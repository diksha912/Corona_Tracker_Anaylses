...
export default class App extends React.Component{
    ...
    async getData(){
        ...
        const countries = [];
        for(var i = 0; i < resCountries.countries.length; i++){
            countries.push(resCountries.countries[i].name);
        }
        //const countries = Object.keys(resCountries.data.countries);
        this.setState({
            confirmed:resApi.confirmed,
            recovered:resApi.recovered,
            deaths:resApi.deaths,
            countries
        });
    }
